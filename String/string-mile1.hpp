...
const int STRING_SIZE = 256; //The size of the array.
...
public:
    ...
    String  operator+     (const String&)      const; //Concatenation //new string
    String& operator+=    (String);                   //Concatenation //changes origional- "a += b" a will be changed
